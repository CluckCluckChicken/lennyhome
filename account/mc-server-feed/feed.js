  ...
  feedBaseDocumentRef.get().then(function(doc) {
      if (doc.exists) {
          ...
          .then(function(querySnapshot) {
              ...
              document.getElementById("serversList").innerHTML += "<input class='w3-input inline-block w3-round-large' id='newServerName' placeholder='Display name' style='width: 25%;' type='text'><select class='w3-input inline-block w3-round-large' id='newServerEdition' style='width: 25%;' type='text'><option value="java">Java Edition</option><option value="bedrock">Bedrock Edition (Pocket, Win10, new PS4, Xbox One, etc)</option><option value="console">Legacy Console Edition (Nintendo, old PS4, Xbox 360, etc)</option></select><button class='w3-btn w3-dark-grey w3-round-large inline-block' onclick='CreateFeed(document.getElementById(&#34newServerName&#34).value)'>New server</button>";
          })
